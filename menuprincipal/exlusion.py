def exclusion():
	...
	resuelvo=("RESUELVO: "+romano[0]+"Téngase por recibidas denuncia de "+sexo+" "+ NombreDenunciante+" con domicilio en "+ DomicilioDenunciante+ "\n"+
				...
				romano[2]+"Ordenar "+sexo1+" "+NombreDenunciado+" la exclusion DE ACCESO Y ACERCAMIENTO respecto de "+sexo+" "+NombreDenunciante+" y tambien del domicilio sito en "+DomicilioDenunciante+" y de donde estos se encuentren viviendo, como también sus lugares de trabajo y/o concurrencia o circulación, por el término de "+cm+". Hágase saber al denunciado que la prohibición de acercamiento importa suspender todo tipo de contacto físico, telefónico, de telefonía celular, de correo postal y electrónico, redes sociales y/o por cualquier medio que signifique una intromisión injustificada con relación a la denunciante; todo ello bajo apercibimiento de que ante la desobediencia a la presente medida, se procederá a su ARRESTO por incumplimiento de orden judicial, en los términos y conforme a las facultades otorgadas al suscripto por el artículo 658 ley XII - Nº 27 DJM, quedando a disposición del Juez de Instrucción que por turno corresponda y/o de imponerle multa en los  términos del art. 5 de la Ley XIV Nº 6 DJM."+"\n"+
